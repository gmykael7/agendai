...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  // Link seguro: o outro aparelho abre a tela de login e exige e-mail + senha.
    ...
    <div className="space-y-6 sm:space-y-8 animate-fadeIn max-w-3xl">
      ...
      <div className="bg-gradient-to-br from-emerald-950/60 to-slate-900 border-2 border-emerald-500/40 p-5 sm:p-6 rounded-3xl space-y-3.5 shadow-xl">
        ...
        <p className="text-xs text-slate-300">
          Para acessar o painel no smartphone, abra o link abaixo e faça login com o e-mail cadastrado e a senha. Nenhum dado administrativo é enviado pelo link:
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          >
            ...
            {copiedMobileLink ? 'Link Copiado!' : 'Copiar Link Seguro de Login'}
          </button>
        </div>
      </div>
